...
const AddCollab = () => {
  ...
  const handleNewCollabClick = () => {
    setShowForm(true);
  };

  const handleTitleUpdate = (title, revenue, time) => {
    setCollabTitle(title);
    setRevenueShared(revenue);
    setTimePeriod(time);
    ...
    <div className="flex h-screen bg-gray-100 min-h-screen">
      ...
      <div className="ml-72 p-6 flex flex-col w-full">
        <div className="bg-green-100 rounded-lg p-6 shadow-md mb-6">
          <h1 className="text-2xl font-semibold mb-4">Welcome, Mark Nelson!</h1>
        ...
        <div className="flex flex-col items-center justify-center flex-grow mb-10">
          {!showForm ? (
            collabTitle ? (
              <div className="bg-white rounded-lg shadow-md h-24 w-full mb-72 border border-gray-200">
                <div className="m-4">
                  <h2 className="text-xl font-semibold mb-2">{collabTitle}</h2>
              ...
              <div
                ...
                onClick={handleNewCollabClick}
                style={{ height: "200px", width: "300px" }} // Adjust dimensions as needed
              >
